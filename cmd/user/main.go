...
import (
	...
	"github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/application/eventhandler"
	"github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/domain/user"
	persistence "github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/infrastructure/persistence/mysql"
	"github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/infrastructure/repository"
	user_grpc "github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/interfaces/grpc"
	user_http "github.com/mar1n3r0/go-api-boilerplate/cmd/user/internal/interfaces/http"
	...
	go func() {
		eventhandler.Register(
			...
			map[string]eventbus.EventHandler{
				...
				(user.WasAuthenticatedWithProvider{}).GetType(): eventhandler.WhenUserWasRegisteredWithProvider(mysqlConnection, userPersistenceRepository),
